...
public class PetriNet {
  ...
  private void buildNet() {
    ...
    // p0 and p4 have max 5 tokens; p1, p6, p7, and p10 have max 1 token; others
    // start with 0.
    places = new Places();
    ...
    postT8.put(10, 1);
    postT8.put(14, 1);
    Transition t8 = new Transition(8, preT8, postT8, true, 100);
    ...
    postT9.put(13, 1);
    Transition t9 = new Transition(9, preT9, postT9, true, 100);
